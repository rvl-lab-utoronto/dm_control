...
class CheetahTargetVel(base.Task):
  """A `Task` to train a running Cheetah."""

  def initialize_episode(self, physics, target_vel):
    ...
    super(CheetahTargetVel, self).initialize_episode(physics)
  ...
  def get_reward(self, physics):
    ...
    return rewards.tolerance(physics.speed()-self._target_vel,
